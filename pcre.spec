...
%prep
%setup -q -n pcre-4e3965851c3a2315abd50ee91f46e22bceeb44a0
pushd ..
cp -a pcre-4e3965851c3a2315abd50ee91f46e22bceeb44a0 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1522789768
export AR=gcc-ar
...
%exclude /usr/lib64/libpcre16.so.0.2.10
%exclude /usr/lib64/libpcre32.so.0
%exclude /usr/lib64/libpcre32.so.0.0.10
